...
### OUTPUT:
<img width="903" height="24" alt="image" src="https://github.com/user-attachments/assets/4a65e66f-34f0-4935-8bbc-e85d58527abd" />


### RESULT:
The chatbot successfully extracts content from the provided PDF document and answers user queries based on the text.
